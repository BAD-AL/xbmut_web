...
![Save mgr](img/8.0-Use-Script.png)
---
#### Info:
...
#### Instructions 
copy Files [1 time]:
1. Boot the included ['UnleashX.iso'](UnleashX-savMgr.iso.7z) in XEMU. ![Save mgr](img/1-UnleashX.png)
...
![Save mgr](img/2-FileBrowser-1.png)
![Save mgr](img/3-FileBrowser-2.png)
![Save mgr](img/4-FileBrowser-3.png)
...
2. Choose Porgrams -> Scripts -> Save Manager ![Save mgr](img/6-Select-Script.png)  ![Save mgr](img/7-Run-Script.png)
3. Select memory location (HDD / memory unit) ![Save mgr](img/8.0-Use-Script.png)
